...
sampleText2a = sampleText2.format("Marchel", "18", "Math")
print(sampleText2a)

sampleText3 = "My name is {0}, I am {1} years old, I love {3}"
sampleText3a = sampleText3.format("Marchel", "18", "Math")
print(sampleText3a)

sampleText4 = "My name is {name}, I love {food}, I am {age}."
sampleText4a = sampleText4.format(age="18", name="Alia", food="Pancit bihon")
print(sampleText4a)
